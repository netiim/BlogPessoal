...
{
    public static void AdicionaImagens(List<string> codigoImagens, ref string html)
    {
    ...
    public static KeyValuePair<string,string> BuscaUrlImagem(string item)
    {
        Dictionary<string, string> mapImagens = GoogleSheetsService.LerPlanilha();
